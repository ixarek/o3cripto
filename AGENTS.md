...
7. Сейчас получилось выставить позиции DOGEUSDT и XRPUSDT (но SL и TP не установлены), также есть ошибки в bot.py
   ...
   12. Мне нужно разработать тактику торговли, которая давала бы точный take profit на анализе графика торгуемых торговых пар за последние пол года. (работаем тут)
